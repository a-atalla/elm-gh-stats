...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../node_modules/typeface-cairo/index.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./files/cairo-latin-200.woff2":[["cairo-latin-200.44715d65.woff2","../node_modules/typeface-cairo/files/cairo-latin-200.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-200.woff2"],"./files/cairo-latin-200.woff":[["cairo-latin-200.0fddc534.woff","../node_modules/typeface-cairo/files/cairo-latin-200.woff"],"../node_modules/typeface-cairo/files/cairo-latin-200.woff"],"./files/cairo-latin-300.woff2":[["cairo-latin-300.8a9706c9.woff2","../node_modules/typeface-cairo/files/cairo-latin-300.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-300.woff2"],"./files/cairo-latin-300.woff":[["cairo-latin-300.2fcdd5b7.woff","../node_modules/typeface-cairo/files/cairo-latin-300.woff"],"../node_modules/typeface-cairo/files/cairo-latin-300.woff"],"./files/cairo-latin-400.woff2":[["cairo-latin-400.83f5b32c.woff2","../node_modules/typeface-cairo/files/cairo-latin-400.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-400.woff2"],"./files/cairo-latin-400.woff":[["cairo-latin-400.3924a082.woff","../node_modules/typeface-cairo/files/cairo-latin-400.woff"],"../node_modules/typeface-cairo/files/cairo-latin-400.woff"],"./files/cairo-latin-600.woff2":[["cairo-latin-600.138e4b5c.woff2","../node_modules/typeface-cairo/files/cairo-latin-600.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-600.woff2"],"./files/cairo-latin-600.woff":[["cairo-latin-600.36778b55.woff","../node_modules/typeface-cairo/files/cairo-latin-600.woff"],"../node_modules/typeface-cairo/files/cairo-latin-600.woff"],"./files/cairo-latin-700.woff2":[["cairo-latin-700.4dfd51be.woff2","../node_modules/typeface-cairo/files/cairo-latin-700.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-700.woff2"],"./files/cairo-latin-700.woff":[["cairo-latin-700.8fae9cdd.woff","../node_modules/typeface-cairo/files/cairo-latin-700.woff"],"../node_modules/typeface-cairo/files/cairo-latin-700.woff"],"./files/cairo-latin-900.woff2":[["cairo-latin-900.e7d1da2f.woff2","../node_modules/typeface-cairo/files/cairo-latin-900.woff2"],"../node_modules/typeface-cairo/files/cairo-latin-900.woff2"],"./files/cairo-latin-900.woff":[["cairo-latin-900.2f4b918e.woff","../node_modules/typeface-cairo/files/cairo-latin-900.woff"],"../node_modules/typeface-cairo/files/cairo-latin-900.woff"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"style/default.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"style/desktop.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{errorMessage: $elm$core$Maybe$Nothing, isLoading: false, projectName: '', releases: _List_Nil, username: ''},
		$elm$core$Platform$Cmd$none);
};
...
var $author$project$Main$Release = F5(
...
var $author$project$Main$authorDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'avatar_url',
	$elm$json$Json$Decode$string,
	A3(
		...
		'login',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Main$Author)));
var $author$project$Main$releaseDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'assets',
	$elm$json$Json$Decode$list($author$project$Main$assetDecoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'author',
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					$elm$json$Json$Decode$int,
					$elm$json$Json$Decode$succeed($author$project$Main$Release))))));
var $author$project$Main$getReleases = F2(
	function (username, projectName) {
		return $elm$http$Http$get(
			{
				expect: A2(
					$elm$http$Http$expectJson,
					$author$project$Main$DataReceived,
					$elm$json$Json$Decode$list($author$project$Main$releaseDecoder)),
		...
		switch (msg.$) {
			case 'SendHttpRequest':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{errorMessage: $elm$core$Maybe$Nothing, isLoading: true}),
					A2($author$project$Main$getReleases, model.username, model.projectName));
			case 'DataReceived':
				if (msg.a.$ === 'Ok') {
					var releases = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{isLoading: false, releases: releases}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$ProjectNameChange = function (a) {
	return {$: 'ProjectNameChange', a: a};
};
...
var $author$project$Main$formatSize = function (size) {
	return A2($myrho$elm_round$Round$round, 2, size / 1000000) + ' MB';
};
var $author$project$Main$viewAsset = function (asset) {
	return A2(
		$elm$html$Html$li,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('asset')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('asset-name')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(asset.name)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('asset-info')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('icon-text size')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('network_check')
									])),
								$elm$html$Html$text(
								$author$project$Main$formatSize(asset.size))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('cloud_download')
									])),
								$elm$html$Html$text(
...
var $author$project$Main$viewAssets = function (assets) {
	return A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Main$viewAsset, assets));
};
var $author$project$Main$viewName = function (release) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('result-item')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('release-name')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$text(release.author.login)
							]))
					])),
				$author$project$Main$viewAssets(release.assets)
			]));
};
var $author$project$Main$viewReleases = function (releases) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Main$viewName, releases));
};
var $author$project$Main$viewReleasesOrError = function (model) {
	if (model.isLoading) {
		...
		if (_v0.$ === 'Just') {
			...
			return $author$project$Main$viewReleases(model.releases);
		}
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('input username-input'),
										$elm$html$Html$Attributes$value(model.username),
										$elm$html$Html$Events$onInput($author$project$Main$UserNameChange)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$class('input project-name-input'),
										$elm$html$Html$Attributes$value(model.projectName),
										$elm$html$Html$Events$onInput($author$project$Main$ProjectNameChange)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$button,
				...
				_List_fromArray(
					[
						$author$project$Main$viewReleasesOrError(model)
					]))
			]));
};
